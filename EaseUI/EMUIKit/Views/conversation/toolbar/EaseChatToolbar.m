...
//    _inputTextView.placeHolder = @"input a new message";
...
//    [self.recordButton setTitle:@"hold down to talk" forState:UIControlStateNormal];
    [self.recordButton setTitle:kTouchToFinish forState:UIControlStateHighlighted];
//    [self.recordButton setTitle:@"loosen to send" forState:UIControlStateHighlighted];
